...
CREATE  TABLE IF NOT EXISTS `12ac3d11`.`guardian` (
  ...
  CONSTRAINT `contactID`
    ...
    REFERENCES `12ac3d11`.`contact` (`contactID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `12ac3d11`.`child` (
  ...
  CONSTRAINT `guardianID`
    ...
    REFERENCES `12ac3d11`.`guardian` (`guardianID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `contactID`
    FOREIGN KEY (`contactID` )
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `staffNumber`
    FOREIGN KEY (`staffNumber` )
    REFERENCES `12ac3d11`.`staff` (`staffNumber` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `roomName`
    FOREIGN KEY (`roomName` )
    REFERENCES `12ac3d11`.`room` (`roomName` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `12ac3d11`.`emergencyContact` (
  ...
  CONSTRAINT `guardianID`
    FOREIGN KEY (`gurdianID` )
    REFERENCES `12ac3d11`.`guardian` (`guardianID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `childID`
    FOREIGN KEY (`childID` )
    REFERENCES `12ac3d11`.`child` (`childID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `contactID`
    FOREIGN KEY (`contactID` )
